        ...
        try {
            ...
            if (existing) {
                ...
                if (!passwordMatches) {
                    ...
                    this.logger.log(`Default admin password reset for user: ${username}`)
                }
                return
            }
            ...
            this.logger.warn(`Default admin initialization skipped: ${error instanceof Error ? error.message : String(error)}`)
        }
    }
