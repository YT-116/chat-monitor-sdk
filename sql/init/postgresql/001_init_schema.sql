...
VALUES (
    'admin',
    '$2a$10$YnIaKpej2BxLJBS6qRzN2u9yLetc5yi4C06Vlx5iJ0hdR2FnBqIkq',
    'admin@skymonitor.local',
    'admin'
)
ON CONFLICT (username) DO UPDATE
SET password = EXCLUDED.password,
    email = COALESCE(admin.email, EXCLUDED.email),
    role = COALESCE(admin.role, EXCLUDED.role);
...
CREATE TABLE IF NOT EXISTS dashboard_widget (
    ...
    "widgetType" VARCHAR(50) NOT NULL CHECK ("widgetType" IN ('line', 'bar', 'area', 'pie', 'radar', 'table', 'world_map', 'big_number')),
